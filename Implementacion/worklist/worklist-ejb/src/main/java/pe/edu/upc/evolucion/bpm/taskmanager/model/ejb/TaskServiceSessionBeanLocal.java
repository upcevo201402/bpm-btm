 ...
 */
@Local
public interface TaskServiceSessionBeanLocal {
    /**
     *
     * @param ctx
     * @param task
    ...
    /**
     * Nominate an organization entity to process the task. If it is nominated to
     * one person then the new state of thetask is Reserved. If it is nominated 
     * to several people then the new state of the task is Ready.
     * 
     * @param ctx
     * @param taskId
     * @param organizationalEntity 
