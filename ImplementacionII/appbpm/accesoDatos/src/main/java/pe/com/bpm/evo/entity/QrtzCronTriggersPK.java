...
public class QrtzCronTriggersPK implements Serializable {
    ...
    public QrtzCronTriggersPK(String schedName, String triggerName, String triggerGroup) {
    ...
    public String toString() {
        return "com.bpmbtm.accesodato.QrtzCronTriggersPK[ schedName=" + schedName + ", triggerName=" + triggerName + ", triggerGroup=" + triggerGroup + " ]";
    }
