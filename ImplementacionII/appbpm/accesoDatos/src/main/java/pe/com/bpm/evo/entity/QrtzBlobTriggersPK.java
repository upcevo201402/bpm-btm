...
public class QrtzBlobTriggersPK implements Serializable {
    ...
    public QrtzBlobTriggersPK(String schedName, String triggerName, String triggerGroup) {
    ...
    public String toString() {
        return "com.bpmbtm.accesodato.QrtzBlobTriggersPK[ schedName=" + schedName + ", triggerName=" + triggerName + ", triggerGroup=" + triggerGroup + " ]";
    }
